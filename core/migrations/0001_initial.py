# Generated by Django 2.2.2 on 2019-12-27 07:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shirt'), ('SW', 'Sport Wear'), ('OW', 'Outwear')], default='', max_length=2)),
                ('label', models.CharField(choices=[('P', 'primary'), ('S', 'secondary'), ('D', 'danger')], default='', max_length=1)),
                ('slug', models.SlugField(default='')),
                ('description', models.TextField(default='')),
                ('additional_info', models.TextField(default='')),
                ('image', models.ImageField(blank=True, null=True, upload_to='')),
                ('image_sub_one', models.ImageField(blank=True, null=True, upload_to='')),
                ('image_sub_two', models.ImageField(blank=True, null=True, upload_to='')),
                ('image_sub_three', models.ImageField(blank=True, null=True, upload_to='')),
